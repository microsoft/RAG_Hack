...
These are the official rules for Hack Together: RAG Hack.
...
2. A description of your experience using AI and RAG to build your entry;
3. An explanation of why you chose to create the entry that you did; and
4. An answer to the question: “How did RAG help you build this solution?
...
- 20% - Usability
- 20% - Solution Quality
- 20% - Alignment with hackathon category (Best in Python, Use of AI Studio, etc.)
...
Each winning team in the categories below will receive a cash prize of $500 in the form of a digital gift card:
- Best overall
- Best in JavaScript
- Best in Java
- Best in .NET
...
Send an email to hacktogether@microsoft.com with the subject line “The Microsoft RAG Hack winners” within thirty (30) days of September 30th, 2024 to receive a list of winners that received a prize.
